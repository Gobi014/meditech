...
import logoani from "C:\\Kirthik\\meditech\\src\\components\\video\\WhatsApp Video 2024-07-30 at 10.13.19_4067eb61.mp4";
  ...
  return (
    <div className="home-container">
      <header className="header">
        ...
        <h1 className="home-title">Welcome to Meditech 24x7</h1>
      </header>
      ...
      <main className="main-content">
        ...
        <section className="medicines-section">
          ...
          <ul className="medicines-list">
            <li><strong>Paracetamol:</strong> Used to reduce fever and relieve pain.</li>
            <li><strong>Ibuprofen:</strong> Used for pain relief, fever reduction, and anti-inflammation.</li>
            <li><strong>Aspirin:</strong> Used as an analgesic, antipyretic, and anti-inflammatory drug.</li>
            <li><strong>Loratadine:</strong> Used to relieve allergy symptoms.</li>
            <li><strong>Omeprazole:</strong> Used to treat acid reflux and stomach ulcers.</li>
            <li><strong>Metformin:</strong> Used to treat type 2 diabetes.</li>
            <li><strong>Atorvastatin:</strong> Used to lower cholesterol.</li>
            <li><strong>Amoxicillin:</strong> Used to treat various bacterial infections.</li>
            <li><strong>Losartan:</strong> Used to treat high blood pressure.</li>
            <li><strong>Amlodipine:</strong> Used to treat high blood pressure and chest pain.</li>
          </ul>
        </section>
